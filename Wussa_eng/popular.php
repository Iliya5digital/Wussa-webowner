...
while ($switched == true) {
 ...
 echo "<center><h1>Most Popular Images</h2></center><br>";
 echo "</p>
 ...
 for ($i=$from1; $i < $from2; $i++) {
   ...
   echo "</a><br><LABEL id='text'>Views: {$views[$i]}</LABEL></td>";
 }
 ...
 {
      $previous = $page - 1;
       echo "<a href='popular.php?page=$previous'><< Previous Page</a>";
 } echo "</td>";    
 ...
 {
      $next = $page + 1;
      echo "<a href='popular.php?page=$next'>Next Page >></a>";
 } echo "</td></tr></table>";
