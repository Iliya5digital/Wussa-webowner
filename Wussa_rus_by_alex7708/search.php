...
&nbsp; &nbsp;<a href="images.php" style="FONT-SIZE: 18px">Новые</a>&nbsp; &nbsp; |
&nbsp; &nbsp;<a href="popular.php" style="FONT-SIZE: 18px">Популярные</a>&nbsp; &nbsp; |
&nbsp; &nbsp;<a href="search.php" style="FONT-SIZE: 18px">Поиск</a>&nbsp; &nbsp;
<br><br><br>
...
echo "<LABEL id='title'>Поиск: </LABEL>&nbsp;<input type='text' name='query' maxlength='100'>";
...
echo  "<tr align=center><td>";
       ...
       if ($session == true) {
         echo "<input type='checkbox' name='safe' value='true' checked> Безопасный поиск";
       }else {
         echo "Безопасный поиск 'Включен'. Вы должны войти,чтобы отключить его.";
       }       
...
if (isset($_GET["query"])) {
     ...
     if ($opt == "tags") {
           ...
           if ($total) {
             ...
             if ($from2 > $found)
             {
              ...
              if ($found != 0) {
                ...
                echo "<center><b>Поиск завершен:</b> Ваш поиск '$query' нашел $found результатов !<br><b>Страниц : $page</b><br><br><br>";
                echo "<table><tr>";
      ...
      if ($opt == "gallery") {
           ...
           if ($total) {
             ...
             echo "Нет общих галерей для поиска !";
  ...
  //**************************************************************************************************************
    ...
    if ($found) {
         ...
         {
              $previous = $page - 1;
              echo "<a href='search.php?query=$query&opt=$opt&page=$previous'><< Предыдущая</a>";
         } echo "</td>";    
         ...
         {
              $next = $page + 1;
              echo "<a href='search.php?query=$query&opt=$opt&page=$next'>Следующая >></a>";
         } echo "</td></tr></table>";
             

   }//$found !=0
   else
         echo "<center>Ваш поиск '$query' не дал результатов!</center>";        
 
 

 }
  else
    echo "<center>Напиши слово для поиска!</center>";
