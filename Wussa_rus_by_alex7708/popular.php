...
while ($switched == true) {
 ...
 echo "<center><h1>Популярные изображения</h2></center><br>";
 echo "</p>
 ...
 for ($i=$from1; $i < $from2; $i++) {
   ...
   echo "</a><br><LABEL id='text'>Просмотров: {$views[$i]}</LABEL></td>";
 }
 ...
 {
      $previous = $page - 1;
       echo "<a href='popular.php?page=$previous'><< Предыдущая</a>";
 } echo "</td>";    
 ...
 {
      $next = $page + 1;
      echo "<a href='popular.php?page=$next'>Следующая >></a>";
 } echo "</td></tr></table>";
  ...
  echo "Ни одоного общего изображения не было загружено!";
