...
if ($from2 > $total)
{
 ...
 echo "<center><h1>Новые изображения</h2></center><br>";
 echo "</p>
 ...
 {
      $previous = $page - 1;
       echo "<a href='images.php?page=$previous'><< Предыдущая</a>";
 } echo "</td>";    
 ...
 {
      $next = $page + 1;
      echo "<a href='images.php?page=$next'>Следующая >></a>";
 } echo "</td></tr></table>";


}
else
  echo "Общих изображений не найдено!";
