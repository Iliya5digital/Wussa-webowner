...
.:: Добавить/Удалить нежелательные изображения ::.
</center></h2></u></font>
...
if (isset($_GET["act"])) {
  ...
  echo "<br><br><a href='abuse.php'>Назад</a> <br>";
...
if ($total) {
 ...
 if ($from2 > $total)
 {
  ...
  echo "<b>Всего '$total' жалоб на изображения.</b><br><br><br>";
  

  echo "<center><table border=1 bordercolor=purple width=500><tr align=center>";
  echo "<td><b>Изображение</b></td>
        <td><b>IP адрес</b></td>
        <td><b>Действие</b></td></tr>";  
  ...
  for ($i=$from1; $i < $from2; $i++) {
    ...
    echo "<td> <a href='abuse.php?act=approve&id={$imageid1}'>Добавить</a>
          ||    <a href='abuse.php?act=delete&id={$imageid1}'>Удалить</a>";
    echo "</tr>";
  ...
  {
     $previous = $page - 1;
     echo "<a href='abuse.php?page=$previous'><< Предыдущая</a>";
  } echo "</td>";    
  ...
  {
     $next = $page + 1;
     echo "<a href='abuse.php?page=$next'>Следующая >></a>";
  } echo "</td></tr></table>";
  ...
  echo "<b>Жалоб на изображения нет!</b>";


echo "<br><br><b>Вы можете запретить загрузку запрещённых изображений нажав сюда<a href='blockip.php'>'Заблокировать IP'</a></b>";
