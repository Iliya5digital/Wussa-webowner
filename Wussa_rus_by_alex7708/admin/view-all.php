...
if ($total) {
 ...
 if ($from2 > $total)
 {
  ...
  echo "<b>Всего <b> '$total' </b> загруженных изображений.</b><br><br>";
  ...
  {
     $previous = $page - 1;
     echo "<a href='view-all.php?page=$previous'><< Предыдущая</a>";
  } echo "</td>";    
  ...
  {
     $next = $page + 1;
     echo "<a href='view-all.php?page=$next'>Следующая >></a>";
  } echo "</td></tr></table>";
