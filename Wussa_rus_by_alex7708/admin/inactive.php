...
.:: Управление неактивными пользователями/изображениями ::.
</center></h2></u></font>
...
if (isset($_GET['act']))
{
   ...
   if ($act == "sendwarnings") {
       ...
       while ($row = mysql_fetch_array($r)) { 
           ...
           $to = $row['email'];
           $subject = "Активируйте свой $webtitle аккаунт!";
  ...
  if ($act == "deleteimages") {  
      ...
      echo "Неактивные изображения удалены!";
...
<br><br>
<font color=brown size=3><b>Неактивные изображения</font>
<hr color=brown><br>
...
if ($total) {
  echo "Всего '$total' неактивных изображений.";
  echo "&nbsp; || <a href='inactive.php?act=deleteimages'>Удалить неактивные изображения</a>"; 
}
else
  echo "Неактивных изображений нет!";
...
<br><br><br><br>
<font color=brown size=3><b>Неактивные аккаунты</font>
<hr color=brown><br>
...
if ($unwarned) {    
  echo "1. Всего '$unwarned' неактивных акаунтов.";
  echo "&nbsp; || <a href='inactive.php?act=sendwarnings'>Отправить предупреждение</a>"; 
}
else
  echo "1. Неактивных аккаунтов нет!";
...
if ($n1) {
  echo "<br><br>2. Всего '$n1' неактивных аккаунтов с предупреждениями.";
  echo "&nbsp; || <a href='inactive.php?act=deleteaccounts'>Удалить аккаунты</a>";
}
else
  echo "<br><br>2. Неактивных аккаунтов с предупреждениями нет!";
