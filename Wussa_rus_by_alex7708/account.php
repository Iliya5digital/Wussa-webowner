...
{ 
   ...
   if (isset($_GET["act"])) {
      $act = $_GET["act"];
       ...
       if ($act == "logout") {
          session_destroy();      
          echo "Вы вышли!";
          echo "<br /><br /><a href='index.php'>Нажмите здесь</a> чтобы перейти на главную";
   ...
   //***********************************************************************************************************
              ...
              if (strlen($newpass) > 5) {
                  ...
                  if ($n) {
                     if (mysql_query("UPDATE `members` SET password = '$newpass', userpass = '$userpass' WHERE id = '$userid'"))
                     {
                        ...
                        echo "Ваш пароль не может быть изменён!";                  
 
                  }
                  else
                     echo "Ваш старый пароль неверный!";
              }
              else
                  echo "Ваш новый пароль меньше,чем 6 знаков!.";
          }
          else
      ...
      echo "<div class='PrivatePassBox' id='privatepass'>
               ...
               Ваш пароль для просмотра личных изображений \"$userpass\"<br><br>
            ...
            <tr align=center>
              ...
              <td>  
               <table width=250><tr>
                  ...
                  <td><LABEL id='text'>Управляйте своими изображениями</LABEL></td>
               </tr></table>
            ...
            <tr align=center>
              ...
              <td>  
               <table width=250><tr>
                  ...
                  <td><LABEL id='text'>Создать,редактировать,удалить галереи</LABEL></td>
               </tr></table>
      ...
      echo "<br><br><table align=center style=\"BORDER: #b1ddf6 2px solid; BACKGROUND: #edf7fd\" width=400>
            <tr align=center>
              ...
              <td>  
               <table width=250><tr>
                  <td valign=top style=\"BORDER-BOTTOM: #42679c 1px dashed; PADDING-BOTTOM: 5px\">
                     <a href='myfavourites.php'>Мои избранные изображения</a>
                  </td>
               </tr><tr height=50>
                  <td><LABEL id='text'>Просматривайте и редактируйте свои изображения!</LABEL></td>
               </tr></table>
      ...
      echo "<br><br><hr color=#b1ddf6><br><table align=center><tr><td height=30 valign=top><h2>Установить Пароль:</h2></td></tr>";
      echo "<tr><td><form method=POST action='account.php' name='myForm'><font size=2>Старый пароль:</td>
            <td><input type=password name='oldpass' size=28></td></tr>
            <tr><td><font size=2>Новый пароль:</td><td><input type=password name='newpass' size=28></td></tr>
            <tr><td><font size=2>Пароль пользователя:</td><td><input type=password name='userpass' size=28></td></tr>
  ...
  echo "Вы должны войти!<br><a href=\"login.php\">Нажмите здесь</a> чтобы войти";
